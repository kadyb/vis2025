...
w zależności od ich wymiarowości oraz jednolistości.

| **Struktura danych** | **Liczba wymiarów** | **Jednolity typ?**  |
|----------------------|---------------------|---------------------|
| Wektor               | 1                   | Tak                 |
| Czynnik              | 1                   | Tak                 |
| Lista                | 1                   | Nie                 | 
...
Do analizy wykorzystamy wbudowany zbiór danych `mtcars`.
...
W pakiecie `nycflights13` znajdziesz zbiór danych `flights`. Wykonaj następujące
zadania:
...
2. Dokonaj analiz opóźnienia odlotów:
