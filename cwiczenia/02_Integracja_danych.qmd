...
Układ szeroki wykorzystywany jest ze względu na to, iż jest bardziej czytelny
dla człowieka i zazwyczaj wymagany jest przez testy statystyczne oraz algorytmy
uczenia maszynowego. Układ długi jest w szczególności dostosowany do baz danych
i programów do przetwarzania danych (jest także wymagany przez pakiet *ggplot2*).
Zazwyczaj modelowanie szeregów czasowych oraz obliczanie statystyk dla grup
wymaga formatu długiego.
